    ...
    <>
      <div>
        ...
        >
          <ParallaxContent>
            <span>
              Un punto de encuentro virtual para el mundo agropecuario, donde la
              venta de ganado es más que un negocio.
            </span>
      ...
      <TextStyled>
        <h1>
          Formularios intuitivos para tu negocio ganadero.<span>&#160;</span>
        </h1>
      </TextStyled>
      <GridContainer>
        <GridText>
          <span>
            Nuestra plataforma simplifica por completo el proceso de guías de
            tránsito, desde el llenado hasta la entrega, garantizando que su
            ganado llegue a su destino con la documentación correcta y completa.
          </span>
        </GridText>
        <GridImage>
      ...
      <DescriptionContainer>
        ...
        <span className="children">
          En GanadoLink, simplificamos el proceso de guías de tránsito de ganado
          con nuestros formularios innovadores. Facilitamos la gestión de la
          documentación para productores y transportistas.
        </span>
      </DescriptionContainer>
      <GridContainer>
        <VideoText>
          ...
          <span className="comment">Una herramienta fantástica para generar formularios de tránsito de ganado, fácil de usar y muy práctica. ¡Realmente útil para mantener registros organizados!</span>
        </VideoText>
        <VideoContainer> 
