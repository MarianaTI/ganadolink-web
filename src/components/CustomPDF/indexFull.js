...
const DownloadAllPDF = ({ orders }) => {
  const generatePDF = () => {
    ...
    const addPageWithOrderData = (order, index) => {
      ...
      doc.text(titleFirstLine, doc.internal.pageSize.width / 2, 17, {
        align: "center",
      });
      doc.text(titleSecondLine, doc.internal.pageSize.width / 2, 27, {
        align: "center",
      });
      doc.text(titleThirdLine, doc.internal.pageSize.width / 2, 37, {
        align: "center",
      });
      ...
      orders.forEach((order, index) => {
        ...
        doc.roundedRect(
          (doc.internal.pageSize.width - cardWidth) / 2,
          yPos,
          cardWidth,
          cardHeight,
          2,
        ...
        doc.text(
          `ARETE`,
          (doc.internal.pageSize.width - cardWidth) / 2 + cardPadding / 2,
          yPos + cardPadding
        );
        doc.text(
          `SINIIGA`,
        ...
        doc.text(
          ...
          (doc.internal.pageSize.width - cardWidth) / 2 +
            ...
            cardPadding -
            5,
          yPos + cardPadding + cardDataYOffset
        );
        ...
        doc.text(
          ...
          (doc.internal.pageSize.width - cardWidth) / 2 +
            ...
            cardPadding -
            5,
          yPos + cardPadding + 10 + cardDataYOffset
        );
        ...
        const vehicleData = order.vehiculo
          ? `${order.vehiculo.marca} ${order.vehiculo.modelo}${
              order.vehiculo.placa ? ` (${order.vehiculo.placa})` : ""
            }`
          : "";
        doc.text(
          vehicleData,
          doc.internal.pageSize.width / 2.2,
